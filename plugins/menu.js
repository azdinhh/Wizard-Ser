...
└─────────────────⸙ \n\ ______`
    ...
    await conn.send2ButtonImg(m.chat, await (await fetch("https://user-images.githubusercontent.com/102433984/161154723-4c4b7a67-e81f-45f7-8839-c36d734b5862.png")).buffer(), text.trim(), '© الغربي ', '.Owner', 'الكل', '.menu', m)
  } catch (e) {
