...
└─────────────────⸙ \n\ ______`
    ...
    await conn.send2ButtonImg(m.chat, await (await fetch("https://user-images.githubusercontent.com/102433984/160944916-7878a248-193f-4104-a8e9-a50ecc5114da.mp4")).buffer(), text.trim(), '© الغربي ', '.Owner', 'الكل', '.menu', m)
  } catch (e) {
